    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center flex flex-col items-center">
        ...
        <div class="relative w-full max-w-3xl">
            <img src="https://cdn.dribbble.com/userupload/20420676/file/original-aac8f7f838812fa53cd92617fad5f892.gif"
                alt="Under construction animation" class="mx-auto rounded-lg w-[500px] h-auto opacity-90" />
        ...
        <p class="py-2 text-red-600 text-lg mb-4">We're working hard to bring you something amazing. Please check back soon!
        </p>
        <!-- Button -->
        <a href="{{ url('/') }}"
            class="bg-black text-white px-10 py-3 text-xl transition-colors tracking-[2px] font-semibold uppercase inline-block hover:bg-gray-800">
            take me home
        </a>
    </div>
@endsection
