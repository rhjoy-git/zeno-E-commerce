        ...
        <div class="lg:w-[60%] xl:w-[58%] bg-white">
            ...
            <div class="px-6 py-6">
                ...
                <div class="space-y-2" x-data>
                    ...
                    @if ($cartItem->product)
                    <div class="cart-item-row relative flex gap-4 items-start py-6 border-t-2 border-gray-200"
                        ...
                        <div class="flex-1 min-w-0 font-semibold">
                            ...
                            <div class="mb-4">
                                ...
                                $savePercentage =
                                $realPrice > 0 ? ($youSave / $realPrice) * 100 : 0;
                                @endphp
        ...
        <div class="lg:w-[40%] xl:w-[42%] bg-white">
            ...
            <div class="px-6 pb-6">
                ...
                <div class="space-y-3 my-4">
                    ...
                    <div class="flex justify-between">
                        <span>Discount</span>
                        <span class="font-semibold text-green-600" id="total-discount">- $9.97</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="uppercase">VAT 5%</span>
                        <span class="font-semibold" id="vat-amount">$3.00</span>
                    </div>
                ...
                <div class="flex justify-between font-semibold border-t-2 border-gray-200 pt-4 text-lg">
                    ...
                    <span id="total-price">$63.00</span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to send the AJAX request to update the cart item
