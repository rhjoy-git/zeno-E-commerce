    ...
    <div class="max-w-7xl mx-auto sm:px-6 md:px-10 lg:px-8 py-16">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-[60%] xl:w-[58%] bg-white">
                <h1 class="text-2xl font-bold mb-4 uppercase ms-6 font-megumi">CheckOut</h1>
                    ...
                    <form action="{{ route('customer.checkout.placeOrder') }}" method="POST">
                        ...
                        <div class="">
                            <p class="text-base text-black ">
                                By continuing, you agree to <a href="{{ route('policies.terms-conditions.policy') }}"
                                    class="underline hover:no-underline" target="_blank">ZENO's
            ...
            <div class="lg:w-[40%] xl:w-[42%] bg-white">
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="mt-6">
                        <h3 class="text-2xl font-semibold mb-4 uppercase tracking-wide font-megumi ">ITEMS YOU ORDERING...
                        </h3>
