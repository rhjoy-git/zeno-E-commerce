...
<div x-show="showCreateModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    <div @click.away="showCreateModal = false" class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        <form @submit.prevent="submitBrandForm" enctype="multipart/form-data" class="p-6">
            <div class="flex justify-between items-center border-b pb-4">
                ...
                <button @click="showCreateModal = false" type="button" class="text-gray-500 hover:text-gray-700">
            ...
            <div class="mt-6 space-y-4">
                <div>
                    ...
                    <input x-model="brandForm.name" type="text" required
                        ...
                        <div class="flex items-center">
                            <label
                                ...
                                <input type="file" @change="
                                       ...
                                       brandForm.logo = $event.target.files[0];
