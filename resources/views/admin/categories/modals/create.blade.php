        ...
        <form @submit.prevent="submitCategoryForm" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mt-6 space-y-4">
                <div>
                    ...
                    <input x-model="categoryForm.name" type="text" required class="w-full px-3 py-2 border rounded-md">
                </div>

                <div>
                    <label class="block text-sm font-medium mb-1">Parent Category</label>
                    <select x-model="categoryForm.parent_id" class="w-full px-3 py-2 border rounded-md">
                ...
                <div>
                    ...
                    <select x-model="categoryForm.status" class="w-full px-3 py-2 border rounded-md">
