...
<div x-data="slider({
    categories: [{
            ...
            image: '{{ asset('images/k1.jpg') }}'
        },
        {
            title: 'Crop Solid Tshirt',
            subtitle: 'Minimal is the key',
            image: '{{ asset('images/k2.jpg') }}'
        },
        {
            title: 'Spicy Jacket',
            subtitle: 'Get Personalised Design',
            image: '{{ asset('images/k3.jpg') }}'
    ...
    <div class="relative h-[400px] bg-cover bg-center flex items-center justify-center text-center"
        ...
        <div class="relative z-10 text-white">
            <h2 class="text-5xl font-semibold tracking-wide uppercase font-megumi ">KID’S FASHION</h2>
    ...
    <div class="mt-4 overflow-hidden relative">
        ...
        <div class="flex items-center justify-between mt-6 gap-4">
            ...
            <div class="flex-1 h-1.5 bg-gray-100 rounded-full">
                <div class="h-full bg-indigo-600 transition-all duration-300 rounded-full" :style="{ width: `${progress}%` }">
                </div>
            </div>
    ...
    <section class="max-w-7xl mx-auto mt-10">
        ...
        <div class="mt-16 text-center">
            <button onclick="window.location.href='{{ route('products.list') }}'" class="bg-black text-white px-10 py-3 text-xl transition-colors tracking-[2px] font-semibold uppercase">
                Find My Style
            </button>
        </div>
    </section>
