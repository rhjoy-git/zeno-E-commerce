    ...
    <div class="relative z-10 max-w-3xl mx-auto">
        ...
        <form class="flex flex-col sm:flex-row justify-center items-center gap-3 max-w-xl mx-auto">
            <input type="email" placeholder="Your email address" required
                class="px-5 py-3 w-full rounded-lg border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-gray-800 placeholder-gray-400 shadow-sm transition-all">
            <button type="submit"
                class="w-full sm:w-auto bg-gray-800 text-white px-8 py-3 rounded-lg hover:bg-gray-900 transition-colors font-medium shadow-md hover:shadow-lg">
                Subscribe
            </button>
        </form>
