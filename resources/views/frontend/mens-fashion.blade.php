...
<div x-data="slider({
    ...
    <!-- End of Men’s Fashion Section -->
    <!-- Men's Products Section -->
    <section class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="text-left mb-8">
            <p class="text-gray-800 font-semibold uppercase">level up</p>
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Your Fashion Game</h2>
        </div>
        <!-- Product Grid -->
