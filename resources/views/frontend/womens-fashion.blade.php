...
<div x-data="slider({
    ...
    <div class="relative h-80 bg-cover bg-center flex items-center justify-center text-center"
        ...
        <div class="relative z-10 text-white">
            <h2 class="text-3xl font-bold">WOMEN’S FASHION</h2>
            <p class="mt-1 text-sm">Discover trendy outfits for every occasion</p>
        </div>
    </div>
    ...
    <section class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="text-left mb-8">
            <p class="text-gray-800 font-semibold uppercase">Because</p>
            <h2 class="text-3xl font-bold text-gray-900 mb-2">You Deserve the Best</h2>
        </div>
        <!-- Product Grid -->
